...
set EXE  = "intel.x_newdev" #overrideSfc_hwrf_constSST_new2"
set rough = "hwrf17"
set MEMO = "coupled_warmstart_nonNeutral_"${rough}"_newdev_dp_"${hord_option}"_"${deglat}"N_"${sst}"K_"${ini_storm}"_"${days}"d_"${res}
...
set restart_dir = "/gpfs/f5/gfdl_w/scratch/Kun.Gao/SHiELD_MOM6/base/20180921.00Z.TC.nh.64bit.non-mono.coupled_noSST_hord6_20N_303.15K_"${ini_storm}"_3.5d_4km/rundir/RESTART"
...
# MOM6 input; needs to be updated !!!
#
set ocean_data_4km_dir = /autofs/ncrc-svm1_home1/Kun.Gao/SHiELD_MOM6/SHiELD_run/MOMSIS_INPUTFILES_4km
...
case "4km":
cp $ocean_data_4km_dir/MOM_input .
cp $ocean_data_4km_dir/MOM_override .
cp $ocean_data_4km_dir/SIS_input .
cp $ocean_data_4km_dir/SIS_override .
...
/
 ...
 &atmos_model_nml
       ...
       fdiag = $fdiag
       fullcoupler_fluxes = .true. !!! must turn this on for coupling
/
